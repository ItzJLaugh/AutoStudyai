...
function LoginPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getToken"])()) router.push('/dashboard');
        }
    }["LoginPage.useEffect"], []);
    async function handleSubmit(e) {
        ...
        try {
            ...
            const data = await resp.json();
            if (resp.ok && data.access_token) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["setToken"])(data.access_token, data.email, data.refresh_token);
...
_s(LoginPage, "Diqz6gHe0b+52zXYhp8aGnBUbwc=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__682015d3._.js.map