...
assert.match(tutor, /retain_context: retainContext/);
...
assert.match(retain, /retainContext/);
assert.match(retain, /selected_answer: currentQ\.options\[i\]/);
assert.match(retain, /correct_answer: currentQ\.options\[currentQ\.correct_index\]/);
